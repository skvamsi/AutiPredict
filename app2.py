...
def predict():
        ...
        if float(output) > (0.5):
                return render_template('form2.html', pred='YSigns of Childhood Disintegrative Disorder detected. Probability: {}%'.format(output))
        else:
                return render_template('form2.html', pred='No signs of Childhood Disintegrative Disorder detected. Probability: {}%'.format(output))
