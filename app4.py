...
def predict():
        ...
        if float(output) > (0.5):
                return render_template('form4.html', pred='Signs of Pervasive Developmental Disorder detected. ASD probability: {}%'.format(output))
        else:
                return render_template('form4.html', pred='No signs of Pervasive Developmental Disorder detected. ASD probability: {}%'.format(output))
