...
def predict():
        ...
        if float(output) > (0.5):
                return render_template('form3.html', pred='Signs of Kanner\'s Syndrome detected. Probability: {}%'.format(output))
        else:
                return render_template('form3.html', pred='No signs of Kanner\'s Syndrome detected. Probability: {}%'.format(output))
